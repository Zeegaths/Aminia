...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="border-b border-purple-500/20 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            {/* Logo */}
            <div className="flex items-center space-x-4">
              <div className="relative group">
                <div className="w-12 h-12 bg-gradient-to-br from-green-500 via-green-600 to-white-600 rounded-xl flex items-center justify-center shadow-lg shadow-purple-500/30 transition-all duration-300 group-hover:shadow-purple-500/50 group-hover:scale-105">
                  <span className="text-white font-black text-xl tracking-wider">
                    A
                  </span>
                </div>
                <div className="absolute inset-0 bg-gradient-to-br from-green-400 to-white-500 rounded-xl opacity-0 group-hover:opacity-20 transition-opacity duration-300 blur-sm"></div>
              </div>
            ...
            <div className="flex items-center">
              {!address ? (
                <Button
                  ...
                  className="bg-gradient-to-r from-green-600 to-white-600 hover:from-green-700 hover:to-green-700 text-white font-bold py-3 px-6 rounded-xl shadow-lg hover:shadow-purple-500/30 transition-all duration-300 transform hover:scale-105 border-0 flex items-center gap-3"
                >
